...
import { ImImage, ImFilePdf, ImFileText2 } from "react-icons/im";
            ...
            <div className="wrapper">
                            ...
                            <Col xs="2">
                                ...
                                <UncontrolledDropdown group>
                                    ...
                                    <DropdownMenu className="reset" >
                                        ...
                                        <DropdownItem onClick={agra_} > <MdPersonAdd className="copy" style={{ fontSize: "26px", marginRight: "8px" }} /> Agregar amigo</DropdownItem>
                                        <DropdownItem onClick={vArcp} > <MdShare className="copy" style={{ fontSize: "26px", marginRight: "8px" }} /> Ver archivos publicos</DropdownItem>
                ...
                >
                    <div className="modal-header justify-content-center">
                        ...
                        <input type="file" id="file" style={{ width: "100%", display: "none" }} accept="image/*, .txt, .pdf"
                            onChange={(event) => {
                                upArchivo(event)
                            }}
                        ></input>
